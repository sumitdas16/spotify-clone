...
const Player = () => {
  ...
  const {track, seekBar, seekBg , playStatus , play, pause, previous, next, time, seekSong } = useContext(PlayerContext);
    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className='flex flex-col items-center gap-1 m-auto'>
        <div className='flex gap-4'>
            ...
            {
              playStatus ? <img  onClick={pause} className='w-5 cursor-pointer' src={assets.pause_icon} alt="" />  
